  ...
  if (personalInfo.name && personalInfo.name.includes(',')) {
    ...
    if (names.length > 1) {
      issues.push({
        ...
        legalBasis: ['15 USC 1681c', '15 USC 1681g'],
      });
  ...
  if (personalInfo.ssn) {
    ...
    if (personalInfo.ssn.includes(',') || 
      ...
      issues.push({
        ...
        legalBasis: ['15 USC 1681c', '15 USC 1681g', '18 USC 1028a'],
      });
    ...
    if (bankruptcyDate) {
      ...
      if ((currentYear - bankruptcyYear) > 7) {
        issues.push({
          ...
          legalBasis: ['15 USC 1681c', '15 USC 1681i'],
        });
...
function checkAccountInaccuracies(account, issues, bureau, reportData) {
  ...
  if (account.paymentStatus?.toLowerCase().includes('late') || 
    ...
    issues.push({
      ...
      legalBasis: ['15 USC 1681s-2(a)(3)', '15 USC 1681e(b)'],
    });
  ...
  if (account.accountType?.toLowerCase().includes('collection') || 
    ...
    issues.push({
      ...
      legalBasis: ['15 USC 1692c', '15 USC 1681s-2(a)(3)', '15 USC 1681e(b)'],
    });
    ...
    if (inquiry.inquiryDate) {
      ...
      if (inquiryDate < oneYearAgo) {
        issues.push({
          ...
          legalBasis: ['15 USC 1681b(a)(2)', '15 USC 1681m'],
        });
