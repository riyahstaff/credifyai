...
export const EXTERNAL_BACKEND_URL = process.env.VITE_EXTERNAL_BACKEND_URL || 'https://api.creditreportanalyzer.com';

// Authentication token for the API (if required)
export const EXTERNAL_BACKEND_TOKEN = process.env.VITE_EXTERNAL_BACKEND_TOKEN || '';

// API version
export const API_VERSION = 'v1';

// Set this to true to enable debug logs for API calls
export const DEBUG_API_CALLS = process.env.NODE_ENV === 'development';
