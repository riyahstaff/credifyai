...
const ArticleDetail = () => {
  ...
  const allArticles = {
    ...
    "fico-vs-vantagescore": {
      ...
      readTime: "9 min read",
      image: "https://images.unsplash.com/photo-1554224155-8d04cb21ed6c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
      author: {
        name: "Jennifer Wu",
    ...
    "rebuild-credit-after-bankruptcy": {
      ...
      content: `
        ...
        <p>Rebuilding credit after bankruptcy requires patience and discipline, but it's entirely possible. Many people find that their credit scores actually recover more quickly after bankruptcy than they would have by struggling with overwhelming debt for years.</p>
        <p>By following a strategic credit rebuilding plan and practicing good financial habits, you can emerge from bankruptcy with stronger money management skills and a more secure financial future. Remember that bankruptcy was designed to give people a second chance—make the most of yours by approaching credit rebuilding with knowledge and purpose.</p>
      `,
      relatedArticles: [
        {
          id: 1,
  ...
  // Use the slug from URL params to find the right article
