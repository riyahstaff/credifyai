  ...
  useEffect(() => {
    const loadLetters = async () => {
      try {
        ...
        // FORCE REGENERATION: Clear old cached letters to use new enhanced format
        // This ensures we always use the new enhanced letter generation
        console.log("Clearing old cached letters to force regeneration with enhanced format");
    ...
    // Make sure to update profile information before loading letters
    if (profile) {
      ...
      console.log("No profile found in auth context");
    }
