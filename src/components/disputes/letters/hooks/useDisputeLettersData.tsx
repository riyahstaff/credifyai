...
import { getUserDisputeLetters } from '@/lib/supabase/disputeLetters';
...
export const useDisputeLettersData = () => {
  ...
  useEffect(() => {
    ...
    // Check for automatically generated letters
    const checkForAutoGeneratedLetters = () => {
      ...
      if (autoGeneratedFlag === 'true' && pendingLetter) {
        try {
          ...
          // Add the new letter to the state
          setLetters(prevLetters => [newLetter, ...prevLetters]);
          
          // Remove the flag and pending letter from session storage
          ...
          // Save the letter if user is logged in
          if (user?.id) {
